...
import oose.dea.tobiascunnen.cotroller.AllAbonnementen;
...
public class AllAbonnementenTest {
    ...
    private AllAbonnementen abonnementen;

    @Before
    public void setUp() {
        this.abonnementen = new AllAbonnementen();
